...
const AuthenticatedClientIndexLazyImport = createFileRoute(
...
const AuthenticatedBoardNoticeLazyImport = createFileRoute(
...
const AuthenticatedClientIndexLazyRoute =
  AuthenticatedClientIndexLazyImport.update({
    id: '/client/',
    path: '/client/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
    import('./routes/_authenticated/client/index.lazy').then((d) => d.Route),
  )
...
const AuthenticatedBoardNoticeLazyRoute =
  AuthenticatedBoardNoticeLazyImport.update({
    id: '/board/notice',
    path: '/board/notice',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any).lazy(() =>
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/board/notice': {
      ...
      path: '/board/notice'
      fullPath: '/board/notice'
      preLoaderRoute: typeof AuthenticatedBoardNoticeLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/settings/account': {
    ...
    '/_authenticated/client/': {
      ...
      path: '/client'
      fullPath: '/client'
      preLoaderRoute: typeof AuthenticatedClientIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
    '/_authenticated/help-center/': {
    ...
    '/_authenticated/client/register/': {
      ...
      preLoaderRoute: typeof AuthenticatedClientRegisterIndexLazyImport
      parentRoute: typeof AuthenticatedRouteImport
    }
  }
}
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/_authenticated/client/": {
      "filePath": "_authenticated/client/index.lazy.tsx",
      "parent": "/_authenticated"
    },
    "/_authenticated/help-center/": {
    ...
    "/_authenticated/client/register/": {
      "filePath": "_authenticated/client/register/index.lazy.tsx",
      "parent": "/_authenticated"
    }
  }
}
