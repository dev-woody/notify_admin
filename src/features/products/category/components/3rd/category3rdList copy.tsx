...
export default function Category3rdList() {
  ...
  const BreadCrumb = [
    ...
    {
      title: '2차 카테고리',
      url: `/product/category/2nd?i=${categories?.categoryUuid}`,
    },
    {
      title: '3차 카테고리',
      url: '',
    ...
    <TableProvider<Category>>
      <Main>
        ...
        <div className='-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-x-12 lg:space-y-0'>
          <CustomTable data={categories?.subCategories} columns={columns} />
        </div>
      </Main>
