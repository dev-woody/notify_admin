...
import { Client } from '../../../../data/schema/users/clientSchema'
import { columns } from './components/inquiry-columns'
      ...
      <Main>
        <div className='mb-2 flex items-center justify-between space-y-2 flex-wrap'>
          <div>
            ...
            <h2 className='text-2xl font-bold tracking-tight'>1:1문의</h2>
